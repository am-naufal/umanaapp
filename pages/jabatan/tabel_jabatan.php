            ...
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <div class="d-flex align-items-center">
                        ...
                        <a class="btn btn-primary btn-sm ms-auto" href="form_jabatan.php">Tambah</a>
                    </div>
                </div>
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center justify-content-center mb-0">
                            ...
                            <tbody>
                                ...
                                $tampil = $koneksi->query("SELECT * FROM tb_jabatan");
                                $no = 1;
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-xs font-weight-bold opacity-7 ps-1" style="text-align:center;">
                                            ...
                                            <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="hapus_jabatan.php?id=<?php echo $r['kd_jabatan']; ?>"><i class="far fa-trash-alt me-2"></i>Hapus</a>
                                        </td>
                                    </tr>
                                <?php
                                    $no++;
