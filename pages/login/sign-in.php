              ...
              <div class="card card-plain ">
                ...
                <div class="card-body">
                  <form role="form" method="post" action="cekLogin.php">
                    <div class="mb-3">
                      <input type="text" name="user" class="form-control form-control-lg" placeholder="username" aria-label="Email">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="text-center">
                      <button type="submit" name="sign" class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">Sign in</button>
                    </div>
                  </form>
                </div>
